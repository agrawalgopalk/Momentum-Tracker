...
def get_search_tool():
    ...
    try:
        ...
        print("[search_tool] Using DuckDuckGo (BaseTool subclass)")
        return WebSearchTool()
    except Exception as e:
        print(f"[search_tool] DuckDuckGo not available: {e}")
    ...
    if tavily_key:
        try:
            ...
            print("[search_tool] Using Tavily (TAVILY_API_KEY found)")
            return TavilySearchTool()
        except ImportError:
            print("[search_tool] TavilySearchTool not installed")
    ...
    if serper_key:
        try:
            ...
            print("[search_tool] Using Serper (SERPER_API_KEY found)")
